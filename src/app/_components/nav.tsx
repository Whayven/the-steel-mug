...
export async function Nav() {
  ...
  return (
    <nav className="relative border-b border-cream-300/60 bg-cream-50 dark:border-zinc-800 dark:bg-zinc-950">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4">
        <div className="flex items-center gap-8">
          ...
          <Link
            href="/menu"
            className="hidden text-sm font-medium uppercase tracking-widest text-zinc-500 transition hover:text-zinc-900 md:inline dark:text-zinc-500 dark:hover:text-white"
          >
            Menu
          </Link>
          <Link
